...
facilities = [
  ...
  {name:"Clinique Muller (Ex-Lorette)", "Address: MGMJ+736, Higginson Street, Curepipe", Facility_type:"clinic"},
  {name:"Clinique Bon Pasteur", "Rue Thomy MU, G. Pitot St, Beau Bassin-Rose Hill 71362", Facility_type:"clinic"},
  {name:"Clinique du Nord", "Clinique du Nord", Facility_type:"clinic"},
  {name:"Phoenix Community Health Centre", Address:"PG74+9JX, Edgar Quirin Avenue, Vacoas-Phoenix", Facility_type: "Clinic"},
  {name:"Rose Hill Area Health Centre", Address:"QF4H+H79, B 1, Beau Bassin-Rose Hill", Facility_type: "clinic"},
  {name:"Medical Surgical Centre Ltd", Address:"Rue Goerge Gilbert,Floreal Georges Guibert St, Curepipe 74111" , Facility_type:"clinic"},
  {name:"Forest-Side Community Health Center", Address:"Curepipe" , Facility_type "clinic"},
  {name:"Holyrood Community Centre", Address:"MFPG+CWM, Reservoir Rd, Vacoas-Phoenix", Facility_type:"clinic"},
]
